...
## mini-parser to get pos tags for s
# from existing CFG file
def getTags(s):
...
### NLTK is not all that it is cracked up to be...
# An NNP is returned as an JJ :-(
# So I guess we'll use a mini-parser
...
#            print("get inflec nns " + nns)
            
            if w == token.text:
                inflections = token.text + "," + nns
